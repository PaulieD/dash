...
BASE_SCRIPTS= [
    ...
    'p2p_invalid_block.py', # NOTE: needs dash_hash to pass
    'p2p_invalid_tx.py', # NOTE: needs dash_hash to pass
    'feature-versionbits-warning.py',
...
EXTENDED_SCRIPTS = [
    ...
    # Longest test should go first, to favor running tests in parallel
    'feature_pruning.py', # NOTE: Prune mode is incompatible with -txindex, should work in litemode though.
